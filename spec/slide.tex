...
\title{Projet de recherche et développement}
\subtitle{Protocole de communication entre FPGA et microcontrôleur sur 1 fil}
...
\section{La pratique}
	...
	\subsection{Eviter les conflits}
		\begin{frame}
			\frametitle{Pas de conflits d'envoi/reception sur la ligne}
			\begin{itemize}
				\item Utilisation d'une variable globale de type "Mutex"
				\item On vérifie si la ligne n'est pas occupée avant d'emettre
			\end{itemize}
		\end{frame}
